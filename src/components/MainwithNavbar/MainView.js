  ...
  return (
    <>
      <div className="main">
        ...
        >
          <div
            className={bars ? "bars" : "bars__none"}
            onClick={() => {
              setTurnOnMobileNavMenu((prev) => !prev);
            }}
          >
            {menu}
          </div>
          ...
          <div
            className={`${
              scroll
                ? "main__socialMedia--scroll"
                : bars
                ? "bars__noMenu"
                : scrollMobile
                ? "main__socialMedia--Mobile"
                : "main__socialMedia"
            }`}
          >
            <div className="navbar__container">
              ...
              <div className="language-select">
                {languages.map(({ code, country_code }) => (
                  <a
                    className={`custom-select ${code}`}
                    key={country_code}
                    onClick={(e) => handleLanguageChange(e, code)}
                    disabled={code === currentLanguageCode}
                    style={{
                      textTransform: "uppercase",
                      color: code === currentLanguageCode ? "#ffbc04" : "",
                    }}
                  >
                    {code}
                  </a>
          ...
          <div className="main__navbar--background">
            ...
            <div className="main__navbar--background--right">
              ...
              <div
                className={
                  scroll
                    ? "main__navbar--background--right--title--hidden"
                    : "main__navbar--background--right--title"
                }
              >
                <h1>
                  Martyna <span>Zych</span>
                </h1>
              </div>
