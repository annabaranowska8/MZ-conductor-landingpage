                ...
                <div className="biography__content--left">
                    <div className="biography__content--left__content">
                        ...
                        <div className="biography__content--text">
                            { t ("biography_one")}<br/><br/>
                            { t ("biography_two")}<br/><br/>
                            { t ("biography_three")}<br/><br/>
                            { t ("biography_four")}<br/><br/>
                            { t ("biography_five")}<br/><br/>
                            { t ("biography_six")}<br/><br/>
                            { t ("biography_seven")}<br/><br/>
                            {t ("biography_eight")}                       
                        </div>
